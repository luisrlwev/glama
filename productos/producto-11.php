...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja troquelada conveniente para empacar y transportar productos que se requieren exhibir. Elaborada con papel 100% reciclado; podemos adaptarla a tus necesidades. ">
    <meta name="keywords" content="Caja troquelada, caja de papel reciclado, cajas de carton para empacar, cajas de carton para transportar, cajas apilables, cajas de carton apilables, cajas de carton para alimentos, cajas de carton para productos de limpieza, cajas de carton para productos químicos, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto11">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Cómoda, versátil, segura</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto11/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto11/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto11/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto11/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja troquelada</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Solución conveniente para empacar y transportar productos que se requieren exhibir.</li>
              <li>Su diseño estructural permite manejar y apilar bandejas encima de otra de forma cómoda y segura.</li>
              <li>Ideal para transportar, enviar o almacenar productos como, alimentos, productos de limpieza, productos químicos, entre otros.</li>
