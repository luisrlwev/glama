...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Panel honeycomb diseñado para proteger al máximo los productos, rellenar espacios o huecos, y para reducir el movimiento. Elaborado 100% de papel reciclado.">
    <meta name="keywords" content="Panel honeycomb, caja de papel reciclado, panel con diseño innovador, panel para proteger el producto, panel para rellenar espacios, panel para rellenar huecos, panel para reducir el movimiento, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto13">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Innovador, protector, resistente</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto13/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto13/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto13/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto13/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Panel honeycomb</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborado con papel 100% reciclado.</li>
              <li>Su diseño innovador tipo panal tiene como objetivo:
              <ul>
              <li>proteger al máximo los productos.</li>
              <li>rellenar espacios o huecos, reduciendo el movimiento de los mismos.</li>
              </ul>
              </li>
