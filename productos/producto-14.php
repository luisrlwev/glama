...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Esquinero utilizado en proceso de paletizado para dar seguridad y estabilidad a la estiba. Elaborado 100% con papel reciclado; lo adaptamos a tus necesidades.">
    <meta name="keywords" content="Esquinero de carton, esquinero de carton para paletizado, carton para estibar, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto14">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Protección, estabilidad, seguridad</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto14/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto14/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto14/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto14/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Esquinero</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborado con papel 100% reciclado.</li>
              <li>Utilizado en proceso de paletizado para dar seguridad y estabilidad a la estiba.</li>
              <li>Se fabrica a las necesidades y especificaciones del cliente, en cualquier tamaño y tipo de material e impresión.</li>
              <li><a href="http://www.apsa.com.mx/empaque-embalaje/esquineros.html" target="_blank" style="color:#07a973; font-weight: 600;">Ir al sitio de APSA</a>.</li>
            </ul>
