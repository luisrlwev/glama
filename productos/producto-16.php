...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja de archivo, embalaje diseñado para guardar y proteger documentos carta y oficio, podemos adaptarnos a tus necesidades.">
    <meta name="keywords" content="Caja de archivo, guardar documentos, proteger documentos, documentos, tamaño carta, tamaño oficio, papel reciclable, caja de cartón.">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto16">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Protección, almacenamiento, manejabilidad</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto16/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto16/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto16/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto16/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja de archivo</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborado con papel 100% reciclable.</li>
              <li>Embalaje diseñado para guardar y proteger documentos tamaño carta y tamaño oficio.</li>
              <li>Se fabrica a las necesidades y especificaciones del cliente.</li>
            </ul>
