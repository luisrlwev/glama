...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Empaque con cartón caple, versátil para desarrollar soluciones atractivas en su diseño e impresión. Elaborado con papel 100% reciclado.">
    <meta name="keywords" content="Empaque con cartón caple, empaque industria alimenticia, empaque industria farmacéutica, empaque confitería, caja industria alimenticia, caja industria farmacéutica, caja confitería, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto17">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Vistoso, atractivo, versátil</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto17/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto17/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto17/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto17/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Empaque con cartón caple</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborado con papel 100% reciclado.</li>
              <li>Su versatilidad permite desarrollar soluciones atractivas en su diseño e impresión. Este tipo de productos es utilizado para la industria alimenticia, farmacéutica, confitera, entre otros.</li>
