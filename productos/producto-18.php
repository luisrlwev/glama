...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Empalmado: su fabricación se basa en corrugado por un lado la cual brinda resistencia adicional. Elaborado con papel 100% reciclable.">
    <meta name="keywords" content="Empalmado, papel corrugado, single face, flauta b, flauta e, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto18">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Llamativo, resistente, versátil</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto18/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto18/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto18/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto18/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Empalmado</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborado con papel 100% reciclable.</li>
              <li>Permite desarrollar soluciones atractivas en su diseño e impresión, así como resistentes.</li>
              <li>Su fabricación se basa en corrugado por un lado (conocido como single face) flauta B o flauta E, la cual brinda resistencia adicional.</li>
