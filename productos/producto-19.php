...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja con micro corrugado (flauta E y B), cajas de menor tamaño y armado moldeable. Elaborada con papel 100% recilado, podemos adaptarla a tus necesidades.">
    <meta name="keywords" content="Caja con micro corrugados, flauta e, flauta b, papel reciclado, caja armado moldeable, cajas para empacar alimentos, cajas para empacar productos, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto19">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Moldeable, versátil, resistente</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto19/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto19/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto19/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto19/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja con micro corrugado (flauta E y B)</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Se fabrica a base de tres papeles.</li>
              <li>Se utiliza principalmente para cajas de menor tamaño y que su armado sea moldeable.</li>
              <li>Su material es utilizado para empacar alimentos, productos de consumo personal, etc.</li>
