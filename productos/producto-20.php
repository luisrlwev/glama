...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Tarima Honeycomb, fabricada con papel 100% reciclado. Ligera en comparación con tarimas las tradicionales, grado alimenticio y excelente costo beneficio.">
    <meta name="keywords" content="Tarima Honeycomb, tarima grado alimenticio, tarimas ligeras, tarimas baratas, tarimas de carton, glama, productos glama">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto20">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Innovadora, resistente, única</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto20/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto20/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto20/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto20/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Tarima Honeycomb</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>A diferencia de su competencia, este productos está fabricado en su totalidad por papel, ofreciendo las siguientes ventajas:
              <ul>
              <li>grado alimenticio.</li>
              <li>costo-beneficio premium.</li>
              <li>ligero en comparación con tarimas tradicionales.</li>
              </ul>
              </li>     
