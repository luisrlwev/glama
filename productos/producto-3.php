...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja con papeles blancos, el empaque es más vistoso, ideal para productos farmacéuticos y de limpieza, podemos adaptarla a tus necesidades.">
    <meta name="keywords" content="Caja con papeles blancos, papel reciclado, caja de cartón, empaques vistosos, empaque para productos de higiene personal, empaque para productos farmacéuticos, empaque para productos limpieza, cajas colectivas para medicamentos, cajas para productos de limpieza">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto3">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Llamativa, limpia, segura</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto3/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto3/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto3/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto3/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja con papeles blancos</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Este tipo de cajas ofrece una alternativa para que el empaque sea más vistoso, debido al tipo de papel utilizado.</li>
              <li>Típicamente, este tipo de material se utiliza para el empaque de productos de higiene personal, productos farmacéuticos y de limpieza.</li>
              <li>Se fabrica a las necesidades y especificaciones del cliente, en cualquier tamaño y tipo de impresión.</li>
            </ul>
