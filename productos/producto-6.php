...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja en corrugado sencillo, diseñada para enviar, transportar o almacenar productos livianos podemos adaptarla a tus necesidades.">
    <meta name="keywords" content="Caja en corrugado sencillo, cajas de papel reciclado, papel engomado, caja de cartón, caja para confitería, caja para textiles, cajas para alimento, caja de fácil sellado">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto6">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Liviana, resistente, segura</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                        <img class="img-fluid img-thumbnail" src="../img/productos/producto6/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                        <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto6/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                        <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto6/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                        <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto6/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja en corrugado sencillo</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Su fabricación está basada en tres papeles.</li>
              <li>Diseñada para enviar, transportar o almacenar productos livianos como confitería, textiles, alimentos, entre otros.</li>
              <li>Fácil sellado con papel engomado.</li>
