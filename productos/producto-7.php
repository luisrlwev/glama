...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Caja en doble corrugado, diseñada para enviar, transportar o almacenar productos pesados, podemos adaptarla a tus necesidades.">
    <meta name="keywords" content="Caja en doble corrugado, cajas de papel reciclado, basada en cinco papeles, empaque versátil y confiable, cajas para transportar, cajas para productos pesados, cajas para almacenar, cajas para refacciones, cajas para liqudos, cajas para documentos">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto7">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Resistente, confiable, segura</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto7/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto7/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto7/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto7/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Caja en doble corrugado</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Su fabricación está basada en cinco papeles.</li>
              <li>Solución de empaque versátil y confiable; las flautas utilizadas ofrecen protección adicional.</li>
              <li>Diseñada para enviar, transportar o almacenar productos pesados, como refacciones, líquidos, documentos, entre otros.</li>
