...
<html lang="es_MX">
  <head>
    ...
    <meta name="description" content="Charola exhibidora para producto y resaltar productos en anaquel. Elaborada con papel 100% reciclado y adaptable a tus necesidades.">
    <meta name="keywords" content="Charola exhibidora para productos, cajas de papel reciclado, cajas para exhibir productos, cajas de carton para anaquel, cajas para cristalería, cajas para alimentos, cajas para productos de limpieza, cajas para textiles, caja de cartón">
    ...
    <div class="container-fluid container-slider">
      ...
      <div id="glamahomeslider" class="carousel slide" data-ride="carousel" data-interval="false">
        <div class="carousel-inner">
          <div class="carousel-item active" id="imageheader-producto8">
            <div class="carousel-caption d-none d-md-block pt-0 text-caption-slider-productos">
              <h1 class="text-left mb-4">Vistosa, resistente, atractiva</h1>
      ...
      <div class="row">
          ...
          <div class="container ">
            <div class="row d-md-block">
                <div class="col-md-8 float-md-right">
                  <img class="img-fluid img-thumbnail" src="../img/productos/producto8/item-1.jpg" alt="" id="full-view">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto8/item-2.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto8/item-3.jpg" alt="">
                </div>
                <div class="col-lg-4 col-md-4 col-6 pb-1 float-md-right thumb-gallery">
                  <img class="img-fluid img-thumbnail prevista" src="../img/productos/producto8/item-4.jpg" alt="">
                </div>
            </div>
          </div>
        </div>
        <div class="col-6 cont-info-gallery-prod">
          <div class="h-100 block-info-prod">
            <h4 class="title-name-producto">Charola exhibidora para producto</h4>
            <ul class="caracteristicas-producto">
              <li>Elaborada con papel 100% reciclado.</li>
              <li>Solución muy conveniente para exhibir y resaltar productos en anaquel.</li>
              <li>Utilizada para productos como cristalería, alimentos, productos de limpieza, textiles, etc.</li>
              <li>Se desarrolla con base en las necesidades y especificaciones de cada cliente, en cualquier tamaño y tipo de material e impresión.</li>
            </ul>
